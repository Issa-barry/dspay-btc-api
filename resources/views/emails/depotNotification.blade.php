...
<head>
  <meta charset="UTF-8">
  <title>Confirmation de votre dépôt</title>
</head>
        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="620" style="max-width:620px;background:transparent;">
          ...
          <tr>
            <td align="center" style="padding:0 12px 16px 12px;color:#6b7280;">
              Bonjour
              {{ optional($depot->user)->nom_complet
                  ?? optional($depot->user)->name
                  ?? optional($depot->user)->email
                  ?? '' }},
            ...
            <td style="padding:0 0 6px 0;">
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background:#ffffff;border:1px solid #e5e7eb;border-radius:16px;">
                ...
                <tr>
                  ...
                  <td style="padding:12px 20px;border-top:1px dashed #e5e7eb;text-align:right;">
                ...
                <tr>
                  ...
                  <td style="padding:12px 20px;border-top:1px dashed #e5e7eb;text-align:right;color:#16A34A;font-weight:600;">
                ...
                <tr>
                  ...
                  <td style="padding:12px 20px;border-top:1px dashed #e5e7eb;color:#1f2937;text-align:right;">
                    {{ optional($depot->created_at)->format('d/m/Y H:i') }}
                  </td>
                </tr>
